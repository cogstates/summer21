...
parser.add_argument('--cluster', type=int, default=1, help = "0 for local, 1 for SeaWulf, 2 for AI Institute")
...
if __name__ == "__main__":
    ...
    val_set = FactbankLoader(file_path = file_path_dev, max_len = args.maxlen_val, tokenizer=tokenizer)
